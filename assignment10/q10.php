...
include "top.php";
    ...
    print"There are less students in Kalkin on Friday than on Wednesday. You can verify by checking the number of classes happening in Kalkin is less on Friday as well.";
